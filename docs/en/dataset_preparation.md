...
| ------------ | ------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Campus       | testset            | [download](https://openxrlab-share.oss-cn-hongkong.aliyuncs.com/xrmocap/xrmocap_meta/Campus/xrmocap_meta_testset.zip) |     Paf data is included.                   |
...
| Shelf        | testset            | [download](https://openxrlab-share.oss-cn-hongkong.aliyuncs.com/xrmocap/xrmocap_meta/Shelf/xrmocap_meta_testset.zip) |      Paf data is included.       |
...
| FourDAG | seq2 | [download](https://openxrlab-share.oss-cn-hongkong.aliyuncs.com/xrmocap/xrmocap_meta/FourDAG/xrmocap_meta_seq2.zip) | Paf data is included.|
| FourDAG | seq4 | [download](https://openxrlab-share.oss-cn-hongkong.aliyuncs.com/xrmocap/xrmocap_meta/FourDAG/xrmocap_meta_seq4.zip) |Paf data is included. |
