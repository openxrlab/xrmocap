...
class PCPMetric(BaseMetric):
    """Percentage of Correct Parts (PCP) metric measures percentage of 
    the corrected predicted limbs.
    ...
    def __call__(self, pred_keypoints3d: Keypoints, gt_keypoints3d: Keypoints, **kwargs):
    ...
    def calc_limbs_accuracy(self,
        ...
        limbs: List[List[int]],) -> Tuple[float, PrettyTable]:
            ...
            for gt_kps3d_idx in gt_kps3d_idxs:
                ...
                for i, limb in enumerate(limbs):
                    ...
                    if check_limb_is_correct(f_pred_kps3d[start_point],
                                            ...
                                            f_gt_kps3d[end_point], self.threshold):
