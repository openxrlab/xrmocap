...
from xrmocap.ops.fourd_association.builder import (
    FourdAssociator, build_fourd_associator
)
...
# yapf: enable
# skel19_info = {'skel19':range(19)}

class FourDAssociationEvaluation:
    ...
    def __init__(self,
                 ...
                 associator: Union[dict, FourdAssociator],
        ...
        if isinstance(associator, dict):
            ...
            self.associator = build_fourd_associator(associator)
        else:
