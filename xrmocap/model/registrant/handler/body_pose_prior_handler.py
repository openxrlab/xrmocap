...
_BodyPosePriorLoss = TypeVar('_BodyPosePriorLoss')


class BodyPosePriorHandler(BaseHandler):

    def __init__(self,
                 prior_loss: Union[_BodyPosePriorLoss, dict],
                 handler_key='body_pose_prior',
                 device: Union[torch.device, str] = 'cuda',
                 logger: Union[None, str, logging.Logger] = None) -> None:
        """Construct a JointPriorHandler instance compute smpl(x/xd) body_pose
        parameters, return a loss Tensor.

        Args:
            prior_loss (Union[BodyPosePriorLoss, dict]):
                An instance of BodyPosePriorLoss, or a config dict of
                BodyPosePriorLoss.
            handler_key (str, optional):
                Key of this input-handler pair.
                Defaults to 'body_pose_prior'.
